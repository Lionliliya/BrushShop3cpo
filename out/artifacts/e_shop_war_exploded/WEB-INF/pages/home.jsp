        ...
        <div id="content">
            ...
            <div class="container">
                <div class="col-md-10" style="float: none; margin: 0 auto;">
                    <div id="main-slider">
                        <div class="item">
                            <img src="/resources/img/slider/fur.png" alt="Кисти для макияжа купить Киев" class="img-responsive">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="/resources/img/slider/real.png" alt="Кисти для макияжа купить Киев">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="/resources/img/slider/real-gift.png" alt="Кисти для макияжа купить Киев">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="/resources/img/slider/real-gift2.png" alt="Кисти для макияжа купить Киев">
                        </div>
                    </div>
                    <!-- /#main-slider -->
                </div>
                    ...
                    <div class="same-height-row">
                        <div class="col-sm-4">
                            <div class="box same-height clickable">
                                ...
                                <h3><a href="#">Честность для наших клиентов</a></h3>
