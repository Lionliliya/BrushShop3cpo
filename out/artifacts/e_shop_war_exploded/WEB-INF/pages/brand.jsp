...
<head>
  ...
  <meta name="description" content="${brand} купить Украина, Киев">
  <meta name="author" content="Liliya Yalovchenko | liliyayalovchenko@gmail.com">
  <meta name="keywords" content="${brand}, купить, недорго, Украина">
...
_________________________________________________________ -->
        <div class="panel panel-default sidebar-menu">
          ...
          <div class="panel-body">
            <ul class="nav nav-pills nav-stacked category-menu">
              <c:set var="curBrand" scope="page" value="${curBrand}"/>
              <c:forEach items="${brands}" var="brand">
                <c:choose>
                  <c:when test="${brand eq curBrand}">
                    <li class="active">
                      <a href="/catalog/brand/${brand}">
                        <c:out value="${brand}"/>
                      </a>
                    </li>
                  </c:when>
      ...
      <div class="col-md-9">
        ...
        <div class="row products">
              <c:forEach items="${productBrand}" var="product">
