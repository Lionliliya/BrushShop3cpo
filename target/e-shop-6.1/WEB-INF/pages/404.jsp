            ...
            <div class="collapse clearfix" id="search">
                ...
                <form class="navbar-form" role="search" method="post" action="/search">
                    <div class="input-group">
                        <input type="text" name="pattern" class="form-control" placeholder="Поиск">
                    ...
                    <div class="row" id="error-page">
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="box">
                                ...
                                <p class="text-center">
                                    <img src="/resources/img/logo.png" alt="Купить кисти для макияжа Киев">
                                </p>

                                <h3>К сожалению, этой страници здесь больше нет</h3>
                                <h4 class="text-muted">Error 404 - Страница не найдена</h4>

                                <p class="text-center">Что бы продолжить используйте <strong>Поисковую форму</strong> или <strong>Меню</strong> сверху.</p>

                                <p class="buttons"><a href="/" class="btn btn-primary"><i class="fa fa-home"></i>На Главную</a>
                                </p>
                            </div>
                        </div>
                    </div>
